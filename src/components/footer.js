'use client'
import { Counter, FooterBottom, FooterCenter, FooterColTitle, FooterColumn, FooterDiv, FooterItem, FooterLinks, FooterRight, StyledGrid } from "@/style/Footer";
            ...
            <Grid size={{xs:12, md: 8}}>
                <Item>
                   <FooterCenter>
                       ...
                       <FooterBottom>
                            <div> &copy; {new Date().getFullYear()} Hex Technologies Inc. </div>
