      ...
      <CenterElement className={isScrolled && "scrolled"}>
        <DropdownWrapper 
          ...
          {openDropdown === "product" && (
            <DropdownContent items={productItems} />
          )}
        </DropdownWrapper>
        ...
        >
          <StyledButton
            onClick={() =>
              setOpenDropdown(openDropdown === "use_cases" ? null : "use_cases")
            }
          >
            <UseCases />
            Use Cases
          ...
          {openDropdown === "use_cases" && (
            <DropdownContent items={useCasesItems} />
          )}
        </DropdownWrapper>
        ...
        >
          <StyledButton>
            <Resources />
            Resources
            <ArrowIconWrapper isOpen={openDropdown === "resources"}>
              <Arrow />
            </ArrowIconWrapper>
          </StyledButton>
          {openDropdown === "resources" && (
            <DropdownContent items={resourcesItems} />
          )}
        </DropdownWrapper>
